            ...
            ?>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    foreach ($header_menus as $menu_item) {
                        if (!$menu_item->menu_item_parent) { //check if menu item has a parent (is a submenu)
                    ...
                    ?>
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo esc_url($menu_item->url); ?>" class="nav-link"><?php echo esc_html($menu_item->title); ?>
                                    </a>
                                </li>
                            <?php
                            } else {
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        ?>
                                            ...
                                            <li><a class="dropdown-item" href="<?php echo esc_url($child_menu_item->url); ?>"><?php echo esc_html($child_menu_item->title); ?></a>
                                            </li>
                                        <?php
